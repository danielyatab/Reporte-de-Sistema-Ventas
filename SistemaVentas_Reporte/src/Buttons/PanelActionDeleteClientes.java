 ...
 * @author yatac
 */
public class PanelActionDeleteClientes extends javax.swing.JPanel {

    public PanelActionDeleteClientes(ModelActionClientes data) {
        initComponents();
        setOpaque(false);
        /*Accion del Boton*/
        btnDelete.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                data.getEvent().onDelete(data.getClientes());
            }
        });
    }
