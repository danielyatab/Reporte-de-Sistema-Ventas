 ...
 * @author yatac
 */
public class PanelActionEditDetalles extends javax.swing.JPanel {

    public PanelActionEditDetalles(ModelActionDetalles data) {
        initComponents();
        setOpaque(false);
        ...
        btnEdit.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                data.getEvent().onEdit(data.getDetalles());
            }
        });
    }
