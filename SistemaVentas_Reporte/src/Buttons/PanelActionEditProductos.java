 ...
 * @author yatac
 */
public class PanelActionEditProductos extends javax.swing.JPanel {

    public PanelActionEditProductos(ModelActionProductos data) {
        initComponents();
        setOpaque(false);
        ...
        btnEdit.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                data.getEvent().onEdit(data.getProducto());
            }
        });
    }
