 ...
 * @author yatac
 */
public class PanelActionDeleteProduct extends javax.swing.JPanel {

    
    public PanelActionDeleteProduct(ModelActionProductos data) {
        initComponents();
        setOpaque(false);
        /*Accion del Boton*/
        btnDelete.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                data.getEvent().onDelete(data.getProducto());
            }
        });
    }
