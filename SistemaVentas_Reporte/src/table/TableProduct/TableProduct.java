...
import Buttons.PanelActionDetalleVentas;
 ...
 * @author yatac
 */
public class TableProduct extends JTable{
    ...
    public void setIconsColumns(int columns, int columnEdit, int columnDelete, int columnDetalle){
        this.columns = columns;
        this.columnEdit = columnEdit;
        this.columnDelete = columnDelete;
        if(columnDetalle == 0){
           this.columnDetalle = -1;     
        }else {
           this.columnDetalle = columnDetalle;      
        }
    }
    ...
    public Component prepareRenderer(TableCellRenderer renderer, int row, int column) {
        ...
        }else if(column == columnDetalle){
           Object o = null;
           ModelActionProductos data;
           data = (ModelActionProductos) o; 
           PanelActionDetalleVentas cell = new PanelActionDetalleVentas(data);   
           return cell;
        }else{
            String value="";
    ...
    public TableCellEditor getCellEditor(int row, int col) {
        ...
        if (col == columnEdit) {
            return new TableCellActionEditProduct();
        } else if(col == columnDelete){
            return new TableCellActionDeleteProduct();
        }else if(col == columnDetalle){
            return new TableCellActionDetalles();
        }else {
