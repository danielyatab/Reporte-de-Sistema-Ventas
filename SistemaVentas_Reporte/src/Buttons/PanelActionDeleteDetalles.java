 ...
 * @author yatac
 */
public class PanelActionDeleteDetalles extends javax.swing.JPanel {

    
    public PanelActionDeleteDetalles(ModelActionDetalles data) {
        initComponents();
        setOpaque(false);
        /*Accion del Boton*/
        btnDelete.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                data.getEvent().onDelete(data.getDetalles());
            }
        });
    }
