 ...
 * @author yatac
 */
public class TableProveedores extends JTable{
    ...
    public TableCellEditor getCellEditor(int row, int col) {
        ...
        if (col == columnEdit) {
            return new TableCellActionEditProveedores();
        } else if(col == columnDelete){
            return new TableCellActionDeleteProveedores();
        } else {
