 ...
 * @author yatac
 */
public class PanelActionEditProveedores extends javax.swing.JPanel {

    public PanelActionEditProveedores(ModelActionProveedores data) {
        initComponents();
        setOpaque(false);
        ...
        btnEdit.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                data.getEvent().onEdit(data.getProveedores());
            }
        });
    }
